...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWVydHRla2ZpZGFuIiwiYSI6ImNrb3VodW4ybjA1cmEydW1wZzFvc3hyNDIifQ.2POUsFSLyXGjiyg3Y7GrMQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup().setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
...
var stripe = Stripe('pk_test_51JYy3dKZa62lb5TUBPizQQ4xjWC9pinbc0UgtA4gw08MccN3duIbZs6NvF3TUnY01IYP6pRJCzUm355HGiBbc1Ys00pzmqoOMb');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; //const tourId  = e.target.dataset.tourId;

...
const createSendToken = (user, statusCode, res) => {
  ...
  // In production server must have HTTPS connection
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currentUser) {
    return next(new AppError('The user belonging token does not exist'));
  }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new AppError('There was an error to send the email. Try again later')
    );
  }
});
